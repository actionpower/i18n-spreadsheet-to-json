...
const rawDataToObjectFormatter = (rawDatas, locale) =>
  rawDatas
    .map((rawData) => {
...
const getI18nMetaFromSpreedSheet = () =>
...
const getI18nDataFromSheet = (fileName) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const configString = fs.readFileSync("i18nconfig.json", "utf8");
    const config = JSON.parse(configString);
...
export const createJsonFile = (title, locale, data) =>
  __awaiter(void 0, void 0, void 0, function* () {
